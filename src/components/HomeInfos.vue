      ...
      <div class="row justify-center items-center">
        <div class="col-md-5 q-ml-lg q-mr-lg">
          <p
            ...
            class="text-h4"
          >
            Located in Statesboro, Soyumi Asian Kitchen has been a breath of fresh air in the food scene of the deep south.
          </p>
          <p class="text-h5">
            Soyumi Asian Kitchen opened in August 2017 in Statesboro, GA. Fueled by the food journeys of the proprietors, Soyumi was developed as a concept to broaden the horizons of it’s patrons as well as it’s team members. Coined from the phrase that’s exclaimed when something tasty hits the spot: “its so yummy!”, we strive to provide an experience that is unlike any other.
          </p>
          <p
        ...
        <div class="col-md-5 q-ml-lg q-mr-lg">
          ...
          >
            Phone <br>
            (912) 871-5999 <br>
            We deliver! Call us! <br>
            <br>
            Location <br>
            727 Buckhead Drive <br>
